...
```{r zemljevid cluster3, echo=FALSE, fig.align='center', fig.cap='Zemljevid 2', warning=FALSE}
zemljevid_cluster3
```

```{r zemljevid cluster4, echo=FALSE, fig.align='center', fig.cap='Zemljevid 3 ', warning=FALSE}
zemljevid_cluster4
```

Iz zemljevidov lahko vidimo, da se države, ki so uvrščajo povsem na vrh glede na bdp na prebivalca hkrati države, v katerih je najmanj prometnih nesreč (obarvane svetlo). Prav tako pa so prometno najnevarnejše države prav tiste, z nizkim bdp (obarvane temneje). 
