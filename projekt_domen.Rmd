...
```{r line, echo=FALSE, message=FALSE, fig.align='center', fig.cap='Deleži uporabe prevoznih     sredstev v Evropskih državah'} 
graf_delez_ljudi
```
...
```{r graf_smrti, echo=FALSE, message=FALSE, fig.align='center',  warning=FALSE, fig.cap='Število smrti v prometnih nesrečah na milijon prebivalcev'} 
graf_smrti
```
